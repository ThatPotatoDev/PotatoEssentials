package dev.thatpotato.potatoessentials.commands.messaging.channels;

import dev.thatpotato.potatoessentials.commands.messaging.channels.ChannelCommand.ChannelArgument;
